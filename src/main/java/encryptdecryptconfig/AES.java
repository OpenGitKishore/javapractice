 ...
 * For example, the Data Encryption Standard (DES) encryption algorithm is
 * considered highly insecure; messages encrypted using DES have been decrypted by brute force within a single day
